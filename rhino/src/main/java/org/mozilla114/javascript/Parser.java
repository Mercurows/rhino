...
import org.mozilla114.javascript.ast.AbstractObjectProperty;
import org.mozilla114.javascript.ast.ArrayComprehension;
import org.mozilla114.javascript.ast.ArrayComprehensionLoop;
import org.mozilla114.javascript.ast.ArrayLiteral;
import org.mozilla114.javascript.ast.Assignment;
import org.mozilla114.javascript.ast.AstNode;
import org.mozilla114.javascript.ast.AstRoot;
import org.mozilla114.javascript.ast.BigIntLiteral;
import org.mozilla114.javascript.ast.Block;
import org.mozilla114.javascript.ast.BreakStatement;
import org.mozilla114.javascript.ast.CatchClause;
import org.mozilla114.javascript.ast.Comment;
import org.mozilla114.javascript.ast.ComputedPropertyKey;
import org.mozilla114.javascript.ast.ConditionalExpression;
import org.mozilla114.javascript.ast.ContinueStatement;
import org.mozilla114.javascript.ast.DestructuringForm;
import org.mozilla114.javascript.ast.DoLoop;
import org.mozilla114.javascript.ast.ElementGet;
import org.mozilla114.javascript.ast.EmptyExpression;
import org.mozilla114.javascript.ast.EmptyStatement;
import org.mozilla114.javascript.ast.ErrorNode;
import org.mozilla114.javascript.ast.ExpressionStatement;
import org.mozilla114.javascript.ast.ForInLoop;
import org.mozilla114.javascript.ast.ForLoop;
import org.mozilla114.javascript.ast.FunctionCall;
import org.mozilla114.javascript.ast.FunctionNode;
import org.mozilla114.javascript.ast.GeneratorExpression;
import org.mozilla114.javascript.ast.GeneratorExpressionLoop;
import org.mozilla114.javascript.ast.GeneratorMethodDefinition;
import org.mozilla114.javascript.ast.IdeErrorReporter;
import org.mozilla114.javascript.ast.IfStatement;
import org.mozilla114.javascript.ast.InfixExpression;
import org.mozilla114.javascript.ast.Jump;
import org.mozilla114.javascript.ast.KeywordLiteral;
import org.mozilla114.javascript.ast.Label;
import org.mozilla114.javascript.ast.LabeledStatement;
import org.mozilla114.javascript.ast.LetNode;
import org.mozilla114.javascript.ast.Loop;
import org.mozilla114.javascript.ast.Name;
import org.mozilla114.javascript.ast.NewExpression;
import org.mozilla114.javascript.ast.NumberLiteral;
import org.mozilla114.javascript.ast.ObjectLiteral;
import org.mozilla114.javascript.ast.ObjectProperty;
import org.mozilla114.javascript.ast.ParenthesizedExpression;
import org.mozilla114.javascript.ast.PropertyGet;
import org.mozilla114.javascript.ast.RegExpLiteral;
import org.mozilla114.javascript.ast.ReturnStatement;
import org.mozilla114.javascript.ast.Scope;
import org.mozilla114.javascript.ast.ScriptNode;
import org.mozilla114.javascript.ast.Spread;
import org.mozilla114.javascript.ast.SpreadObjectProperty;
import org.mozilla114.javascript.ast.StringLiteral;
import org.mozilla114.javascript.ast.SwitchCase;
import org.mozilla114.javascript.ast.SwitchStatement;
import org.mozilla114.javascript.ast.Symbol;
import org.mozilla114.javascript.ast.TaggedTemplateLiteral;
import org.mozilla114.javascript.ast.TemplateCharacters;
import org.mozilla114.javascript.ast.TemplateLiteral;
import org.mozilla114.javascript.ast.ThrowStatement;
import org.mozilla114.javascript.ast.TryStatement;
import org.mozilla114.javascript.ast.UnaryExpression;
import org.mozilla114.javascript.ast.UpdateExpression;
import org.mozilla114.javascript.ast.VariableDeclaration;
import org.mozilla114.javascript.ast.VariableInitializer;
import org.mozilla114.javascript.ast.WhileLoop;
import org.mozilla114.javascript.ast.WithStatement;
import org.mozilla114.javascript.ast.XmlDotQuery;
import org.mozilla114.javascript.ast.XmlElemRef;
import org.mozilla114.javascript.ast.XmlExpression;
import org.mozilla114.javascript.ast.XmlLiteral;
import org.mozilla114.javascript.ast.XmlMemberGet;
import org.mozilla114.javascript.ast.XmlPropRef;
import org.mozilla114.javascript.ast.XmlRef;
import org.mozilla114.javascript.ast.XmlString;
import org.mozilla114.javascript.ast.Yield;
