...
class BodyCodegen {
    ...
    private void generateGenerator() {
        ...
        if (fnCurrent != null) {
            ...
            cfw.addInvoke(
                    ...
                    "org/mozilla114/javascript/Function",
                    "getDeclarationScope",
    ...
    private void generateThrowJavaScriptException() {
        cfw.add(ByteCode.NEW, "org/mozilla114/javascript/JavaScriptException");
        ...
        cfw.addInvoke(
                ...
                "org/mozilla114/javascript/JavaScriptException",
                "<init>",
        ...
        switch (type) {
            ...
            case Token.SUPER:
                {
                    ...
                    cfw.addALoad(variableObjectLocal);
                    cfw.add(ByteCode.CHECKCAST, "org/mozilla114/javascript/NativeCall");
                    cfw.addInvoke(
                            ByteCode.INVOKEVIRTUAL,
                            "org/mozilla114/javascript/NativeCall",
                            "getHomeObject",
                            "()Lorg/mozilla/javascript/Scriptable;");
                    ...
                    cfw.addInvoke(
                            ByteCode.INVOKEINTERFACE,
                            "org/mozilla114/javascript/Scriptable",
                            "getPrototype",
                            "()Lorg/mozilla/javascript/Scriptable;");
            ...
            case Token.GET_REF:
                ...
                if (node.getIntProp(Node.OPTIONAL_CHAINING, 0) == 1) {
                    ...
                    cfw.add(ByteCode.CHECKCAST, "org/mozilla114/javascript/Ref");
    ...
    private void generateLocalYieldPoint(Node node, boolean exprContext) {
        ...
        if (node.getType() == Token.YIELD_STAR) {
            ...
            cfw.add(ByteCode.NEW, "org/mozilla114/javascript/ES6Generator$YieldStarResult");
            cfw.add(ByteCode.DUP_X1);
            cfw.add(ByteCode.SWAP);
            cfw.addInvoke(
                    ByteCode.INVOKESPECIAL,
                    "org/mozilla114/javascript/ES6Generator$YieldStarResult",
                    "<init>",
                    "(Ljava/lang/Object;)V");
        }
    ...
    private void visitArrayLiteralWithSpread(Node node, Node child, int numberOfSpread) {
        ...
        cfw.addInvoke(
                ByteCode.INVOKESTATIC,
                "org/mozilla114/javascript/NewLiteralStorage",
                "create",
        ...
        if (isGenerator) {
            ...
            for (int i = 0; i < count; ++i) {
                if (child.getType() == Token.DOTDOTDOT) {
                    ...
                    cfw.add(ByteCode.CHECKCAST, "org/mozilla114/javascript/NewLiteralStorage");
    ...
    private static String exceptionTypeToName(int exceptionType) {
        if (exceptionType == JAVASCRIPT_EXCEPTION) {
            return "org/mozilla114/javascript/JavaScriptException";
        } else if (exceptionType == EVALUATOR_EXCEPTION) {
            return "org/mozilla114/javascript/EvaluatorException";
        } else if (exceptionType == ECMAERROR_EXCEPTION) {
            return "org/mozilla114/javascript/EcmaError";
